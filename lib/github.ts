...
- Tested in Daytona sandbox: ${incident.tests_passed ? "✅ PASSED" : "❌ FAILED"}

🤖 Generated by AUTO-OPS`;
    ...
    const prTitle = `🔧 AUTO-OPS: Fix ${incident.error_type} in ${incident.filename}`;
...
### Testing Results
${incident.tests_passed ? "✅" : "❌"} **Tested in Daytona Sandbox**
...
🤖 **Generated by AUTO-OPS** | Incident ID: \`${incident.id}\`
🧪 **Tested in**: Daytona isolated environment
🔍 **AI Reviewed by**: CodeRabbit (auto-triggered)`;
}
...
function simulatePRCreation(incident: Incident): string {
  ...
  console.log(`🎭 Simulated GitHub PR creation:`);
  console.log(`Branch: ${branchName}`);
  console.log(`Title: 🔧 AUTO-OPS: Fix ${incident.error_type} in ${incident.filename}`);
